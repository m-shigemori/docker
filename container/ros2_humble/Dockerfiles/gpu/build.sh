...
echo "1. CUDA 12.2.2 (cuDNN 8.x, devel, Ubuntu 22.04)"
echo "2. CUDA 12.5.1 (cuDNN, devel, Ubuntu 22.04)"
echo "3. CUDA 12.8.1 (cuDNN, devel, Ubuntu 22.04)"
echo "4. CUDA 12.9.1 (cuDNN, devel, Ubuntu 22.04)"
